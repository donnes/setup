...
Use the Linear MCP to fetch all issues assigned to "me" that are not completed or cancelled. You are OAuthed so you can fetch my username on Linear to use as assignee.
